...
<body id="kt_body" class="header-fixed header-mobile-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
	...
	<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
		<!--begin::Logo-->
		<a href="<?= base_url() ?>">
			<img alt="Logo2" src="<?= base_url() ?>assets/media/logos/logo-nbrt.png" style=" width: 80%;" />
		</a>
		<!--end::Logo-->
		<!--begin::Toolbar-->
			...
			<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
				...
				<div class="brand flex-column-auto" id="kt_brand">
					...
					<a href="<?= base_url() ?>" class="brand-logo">
						<img alt="Logo1" src="<?= base_url() ?>assets/media/logos/logo-nbrt.png" style=" width: 100%; " />
					</a>
					...
					<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
						...
						<ul class="menu-nav">
							<ul class="menu-nav">
								...
								<li class="menu-item menu-item-submenu" id="donations_menu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="<?= base_url()?>donations" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								...
								<li class="menu-item menu-item-submenu" id="donors_menu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="<?= base_url()?>donors" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<polygon points="0 0 24 0 24 24 0 24"/>
								...
								<li class="menu-item menu-item-submenu" id="cases_menu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="<?= base_url()?>cases" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<rect x="0" y="0" width="24" height="24"/>
								...
								<li class="menu-item menu-item-submenu" id="hospitals_menu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="<?= base_url()?>hospitals" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<rect x="0" y="0" width="24" height="24"/>
								...
								<?php if($this->session->userdata('user_role')=='admin') { ?>
									...
									<li class="menu-item menu-item-submenu" id="committees_menu" aria-haspopup="true" data-menu-toggle="hover">
										...
										<div class="menu-submenu">
											...
											<ul class="menu-subnav">
												...
												<li class="menu-item" id="committees_menu_1" aria-haspopup="true">
													<a href="<?= base_url()?>committees" class="menu-link">
														...
														<span class="menu-text">Committees List</span>
													</a>
												</li>

												<li class="menu-item" id="committees_menu_2" aria-haspopup="true">
													<a href="<?= base_url()?>committees/members" class="menu-link">
								...
								<?php if($this->session->userdata('user_role')=='committee') { ?>
									...
									<li class="menu-item menu-item-submenu" id="committee_members_menu" aria-haspopup="true" data-menu-toggle="hover">
										<a href="<?= base_url()?>committees/members" class="menu-link menu-toggle">
											<span class="svg-icon menu-icon">
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														<polygon points="0 0 24 0 24 24 0 24"/>
								...
								<li class="menu-item menu-item-submenu" id="chart_menu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="<?= base_url()?>chart" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<rect x="0" y="0" width="24" height="24"/>
										...
										<span class="menu-text">Donations Chart</span>
									</a>
								</li>
								...
								<li class="menu-item" aria-haspopup="true" id="password_menu">
									<a href="<?= base_url()?>settings/password" class="menu-link">
										<span class="svg-icon menu-icon">
								...
								<li class="menu-section">
									<h4 class="menu-text">More</h4>
									<i class="menu-icon ki ki-bold-more-hor icon-md"></i>
								</li>

								<li class="menu-item" aria-haspopup="true" id="info_menu">
									<a href="<?= base_url()?>info" class="menu-link">
										...
										<span class="menu-text">Software Info</span>
									</a>
								</li>
